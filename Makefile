...
C_ALGORITHMS = algorithms/countsort/a__countsort.c algorithms/countsort/a__countsort_helpers.c

C_FILES_MANDATORY	= main.c push_swap.c $(C_LINKED_LISTS) $(C_DOUBLY_LINKED_LISTS) $(C_STACK) $(C_OPERATIONS) $(C_HELPERS) $(C_LOG) $(C_VALIDATION) $(C_SORT) $(C_ALGORITHMS)
